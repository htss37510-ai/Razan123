    ...
    <>
      ...
      <div className="order-info-section card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
          <h2>فلاتر الجرد</h2>
          <div className="period-filters" style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            <select 
            ...
            <button 
              ...
              style={{ background: '#e53935', color: 'white', padding: '8px 15px', borderRadius: '8px', marginRight: 'auto', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '5px', fontSize: '14px', fontWeight: 'bold' }}
              title="حذف الطلبيات"
            >
