...
function App() {
  // Apply theme and initialize notifications on application startup
  useEffect(() => {
    const savedTheme = localStorage.getItem('razan-theme') || 'light';
    document.documentElement.setAttribute('data-theme', savedTheme);
    
    // Initialize weekly backup reminder based on settings
    const savedNotifications = localStorage.getItem('razan-notifications');
    const enabled = savedNotifications !== null ? JSON.parse(savedNotifications) : true;
    scheduleWeeklyReminder(enabled);
  }, []);
